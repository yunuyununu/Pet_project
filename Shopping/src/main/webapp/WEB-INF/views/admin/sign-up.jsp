...
<body class="">
  ...
  <nav class="navbar navbar-expand-lg position-absolute top-0 z-index-3 w-100 shadow-none my-3 navbar-transparent mt-4">
    <div class="container">
      <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 text-white" href="../pages/dashboard.jsp">
        Argon Dashboard 3
      </a>
  ...
  <!--   Core JS Files   -->
  <script src="/resources/images/js/core/popper.min.js"></script>
  <script src="/resources/images/js/core/bootstrap.min.js"></script>
  <script src="/resources/images/js/plugins/perfect-scrollbar.min.js"></script>
  <script src="/resources/images/js/plugins/smooth-scrollbar.min.js"></script>
  <script>
  ...
  <script src="/resources/images/js/argon-dashboard.min.js?v=2.1.0"></script>
</body>
</html>