...
import com.example.Shopping.user.model.dao.LoginDAO;
...
//
	...
	public ModelAndView loginCheck(LoginDTO dto, HttpSession session,ModelAndView mav) {
		String m_name = loginDao.login(dto);
		if(m_name != null) {
